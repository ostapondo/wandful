...
- **Windows.** Back in CI and the release matrix, and run on Windows 11 at
  ...
  than failing silently. Drawing a rune by hand, the shortcut recorder, the
  five System actions, the elevated-window check and anything with a second
  monitor are still untested there — see the

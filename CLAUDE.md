...
## Name
The project is called **Wandful** (magic wand + shortcuts). Use this name everywhere:
app title, window titles, bundle/product name, package name, docs, marketing copy.
Do not rename it or introduce alternative names.
